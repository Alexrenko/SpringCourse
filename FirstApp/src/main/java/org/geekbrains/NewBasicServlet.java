...
@WebServlet(name = "NewBasicServlet", urlPatterns = "/new_basic_servlet")

public class NewBasicServlet implements Servlet {

    private static Logger logger = LoggerFactory.getLogger(NewBasicServlet.class);
    ...
    public void service(ServletRequest req, ServletResponse res) throws
        ...
        res.getWriter().println("<h1>EEE!!! It`s work!! :DD</h1>");
    }
